...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1774214141);
user_pref("app.update.lastUpdateTime.background-update-timer", 1774214141);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1774237058);
user_pref("app.update.lastUpdateTime.region-update-timer", 1774078081);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1774238563);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1774214141);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1774214141);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "5edae77d-39f0-478d-80d1-336dd5e7bf43");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1774076320);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{4929dc47-b5fc-4db3-aea9-b6969ccf9792}");
...
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20260112023630");
user_pref("browser.shell.checkDefaultBrowser", false);
user_pref("browser.startup.couldRestoreSession.count", 2);
user_pref("browser.startup.homepage", "about:blank");
user_pref("browser.startup.homepage_override.mstone", "ignore");
user_pref("browser.startup.lastColdStartupCheck", 1774238563);
...
user_pref("captchadetection.lastSubmission", 1774076);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "7cfa8fb4-6112-4a2a-8b60-33ac84291474");
user_pref("datareporting.dau.cachedUsageProfileID", "d667f801-3ab3-429a-b1c8-0a30ddf3495b");
...
user_pref("extensions.lastAppBuildId", "20260112023630");
...
user_pref("extensions.webextensions.uuids", "{\"data-leak-blocker@mozilla.com\":\"38296144-0955-4cf7-94cd-c810b85db6f3\",\"formautofill@mozilla.org\":\"f18527b2-caab-4360-a91b-033b28660418\",\"ipp-activator@mozilla.com\":\"50643400-c32a-4b1d-8e1e-3e7c4753b100\",\"pictureinpicture@mozilla.org\":\"b2410adb-1dc5-4287-97d5-54f92905aa29\",\"addons-search-detection@mozilla.com\":\"fab07143-2e50-4a26-bc1b-3dcb8f35177f\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"newtab@mozilla.org\":\"5afb7b29-9aca-4b7c-8fb3-39845a452e19\",\"default-theme@mozilla.org\":\"8113c37f-4cd9-4308-92b5-e5a8e46cfda9\"}");
...
user_pref("idle.lastDailyNotification", 1774151323);
...
user_pref("media.gmp-manager.buildID", "20260112023630");
user_pref("media.gmp-manager.lastCheck", 1774199839);
user_pref("media.gmp-manager.lastEmptyCheck", 1774199839);
...
user_pref("nimbus.profileId", "2a52bff2-00f2-4601-ac2e-695a6a41b5b0");
user_pref("pdfjs.disabled", true);
user_pref("pdfjs.enabledCache.state", false);
user_pref("permissions.isolateBy.userContext", true);
user_pref("places.database.lastMaintenance", 1774151323);
user_pref("plugin.state.flash", 0);
user_pref("privacy.bounceTrackingProtection.hasMigratedUserActivationData", true);
user_pref("privacy.clearOnShutdown_v2.formdata", true);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1774151323508");
...
user_pref("storage.vacuum.last.places.sqlite", 1774151323);
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.profiles.storeID", "c8a3d531");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1774238561);
...
user_pref("toolkit.telemetry.previousBuildID", "20260112023630");
